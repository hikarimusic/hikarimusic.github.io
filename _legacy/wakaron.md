...
いつも「ワカロン｜小学生でもわかる最新論文」をご利用いただき、ありがとうございます。

誠に残念ながら、運営費用（月額約200ドル）の確保が困難となったため、現在サービスを一時休止しております。

**主な運営コスト：**
- フロントエンド・バックエンドのホスティング費用
- AI による記事・画像生成費用

皆様に科学の面白さをお届けできないこと、大変心苦しく思っております。
</div>

<div class="notice--success" markdown="1">
## 【スポンサー様募集のお願い】

「ワカロン」は、最新の科学論文を小学生でも理解できるよう解説し、科学への興味を広げることを目的としたサービスです。

**サービスの特徴：**
- 論文クロール、コンテンツ生成、ファイル管理まで完全自動化を実現
- 人件費不要で、サーバー・API費用のみで運営可能

**スポンサーメリット：**
- サイト内でのスポンサー紹介
- 科学教育・普及活動への貢献

月額200ドル程度の運営費用でこのサービスを継続できます。科学普及活動にご賛同いただける企業様・個人様がいらっしゃいましたら、ぜひご連絡をお待ちしております。

お問い合わせ：hikarimusic.tm@gmail.com
</div>
